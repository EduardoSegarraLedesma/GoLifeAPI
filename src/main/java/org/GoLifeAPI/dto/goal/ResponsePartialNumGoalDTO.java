...
public class ResponsePartialNumGoalDTO extends ResponsePartialGoalDTO {

    private Double valorObjetivo;
    private String unidad;

    public ResponsePartialNumGoalDTO(ObjectId _id, String nombre, Enums.Tipo tipo, String fecha,
